...
protected:
	...
	smtutil::Expression
	division(smtutil::Expression _left, smtutil::Expression _right, IntegerType const& _type);
	...
	VariableIndices
	visitBranch(ASTNode const* _statement, smtutil::Expression const* _condition = nullptr);
