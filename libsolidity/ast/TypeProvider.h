...
public:
	...
	static ArrayType const*
	array(DataLocation _location, Type const* _baseType, u256 const& _length);
	...
	static FixedPointType const*
	fixedPoint(unsigned m, unsigned n, FixedPointType::Modifier _modifier);
	...
	static ReferenceType const*
	withLocation(ReferenceType const* _type, DataLocation _location, bool _isPointer);

	/// @returns a copy of @a _type having the same location as this (and is not a pointer type)
	///          if _type is a reference type and an unmodified copy of _type otherwise.
	///          This function is mostly useful to modify inner types appropriately.
	static Type const*
	withLocationIfReference(DataLocation _location, Type const* _type, bool _isPointer = false)
	{
	...
	static RationalNumberType const*
	rationalNumber(rational const& _value, Type const* _compatibleBytesType = nullptr);
