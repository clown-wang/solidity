...
SourceUnit::referencedSourceUnits(bool _recurse, set<SourceUnit const*> _skipList) const
{
...
vector<pair<util::FixedHash<4>, FunctionTypePointer>> const&
ContractDefinition::interfaceFunctionList(bool _includeInheritedFunctions) const
{
