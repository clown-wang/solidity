...
CompilerContext::superFunction(FunctionDefinition const& _function, ContractDefinition const& _base)
{
...
CompilerContext&
CompilerContext::appendConditionalRevert(bool _forwardReturnData, string const& _message)
{
