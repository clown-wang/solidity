...
public:
	...
	/// single variable.
	std::string
	extractFromStorageValue(Type const& _type, size_t _offset, bool _splitFunctionTypes);
	...
	static std::string
	revertReasonIfDebug(RevertStrings revertStrings, std::string const& _message = "");
