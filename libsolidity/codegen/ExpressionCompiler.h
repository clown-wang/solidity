...
private:
	...
	void
	appendShiftOperatorCode(Token _operator, Type const& _valueType, Type const& _shiftAmountType);
	...
	void
	acceptAndConvert(Expression const& _expression, Type const& _type, bool _cleanupNeeded = false);
