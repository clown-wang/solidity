...
public:
	...
	parse(std::shared_ptr<langutil::Scanner> const& _scanner, bool _reuseScanner);
...
private:
	...
	void
	addNamedSubObject(Object& _container, YulString _name, std::shared_ptr<ObjectNode> _subObject);
