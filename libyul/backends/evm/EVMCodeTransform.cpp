...
CodeTransform::functionEntryID(YulString _name, Scope::Function const& _function)
{
...
size_t
CodeTransform::variableHeightDiff(Scope::Variable const& _var, YulString _varName, bool _forSwap)
{
