...
public:
	...
	void
	parserError(ErrorId _error, SourceLocation const& _location, std::string const& _description);
	...
	void
	syntaxError(ErrorId _error, SourceLocation const& _location, std::string const& _description);
	...
	void
	typeError(ErrorId _error, SourceLocation const& _location, std::string const& _description);
