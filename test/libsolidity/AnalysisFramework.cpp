...
ErrorList
AnalysisFramework::expectError(std::string const& _source, bool _warning, bool _allowMultiple)
{
...
AnalysisFramework::retrieveContractByName(SourceUnit const& _source, string const& _name)
{
