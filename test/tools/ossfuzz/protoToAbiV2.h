...
private:
	...
	assignChecker(std::string const& _varName, std::string const& _paramName, T _type);
...
private:
	...
	static std::string
	variableLengthValueAsString(unsigned _width, unsigned _counter, bool _isHexLiteral);
